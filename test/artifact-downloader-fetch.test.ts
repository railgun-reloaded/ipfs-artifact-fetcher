...
import { ArtifactDownloaderFetch } from '../src/artifact-downloader-fetch.js'
...
describe('artifact-downloader-fetch for snarkjs artifacts', { timeout: 2000000 }, () => {
  let downloader: ArtifactDownloaderFetch

  before(() => {
    const useNativeArtifacts = false
    downloader = new ArtifactDownloaderFetch(testArtifactStore, useNativeArtifacts)
  })
...
describe('artifact-downloader-fetch for native artifacts', { timeout: 200000 }, () => {
  let downloader: ArtifactDownloaderFetch
