...
import { ArtifactDownloaderHeliaHTTP } from '../src/artifact-downloader-helia-http.js'
...
describe('artifact-downloader-helia-http for snarkjs artifacts', { timeout: 2000000 }, () => {
  let downloader: ArtifactDownloaderHeliaHTTP

  before(() => {
    const useNativeArtifacts = false
    downloader = new ArtifactDownloaderHeliaHTTP(testArtifactStore, useNativeArtifacts)
  })
...
describe('artifact-downloader-helia-http for native artifacts', { timeout: 200000 }, () => {
  let downloader: ArtifactDownloaderHeliaHTTP
